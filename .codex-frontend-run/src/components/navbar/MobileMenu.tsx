          ...
          >
            ...
            {session ? (
              ...
              <div className="px-6 pb-4">
                <Link href="/login" onClick={() => setIsOpen(false)} className="block px-4 py-3 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">
                  {t("nav_login")}
                </Link>
              </div>
            )}
            ...
            <div className="px-6 pb-8">
              <Link href="/booking" onClick={() => setIsOpen(false)} className="flex items-center justify-center gap-3 bg-primary text-white w-full py-4 rounded-2xl font-bold shadow-lg">
                <Crown size={18} />
                {t("nav_book")}
              </Link>
            </div>
