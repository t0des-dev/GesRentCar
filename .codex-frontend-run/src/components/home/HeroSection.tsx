...
export default function HeroSection({
  ...
  return (
    ...
    >
      ...
      <HeroBackground
        heroImage={getImageUrl(agency.hero_image_url) || "https://images.unsplash.com/photo-1503377215949-b98377627166?q=80&w=2400&auto=format&fit=crop"}
        heroVideo={agency.hero_video_url || "https://assets.mixkit.co/videos/preview/mixkit-black-luxury-car-driving-on-a-highway-42412-large.mp4"}
      ...
      >
        <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-white/40">Découvrir</span>
