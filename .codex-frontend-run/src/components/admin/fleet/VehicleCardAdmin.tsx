...
export default function VehicleCardAdmin({
  ...
  return (
    <motion.div
      ...
      className="bg-surface-0 rounded-2xl border-2 border-border/60 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md group"
    >
      <div className="h-64 relative overflow-hidden bg-surface-1">
        ...
        {isStar && (
          <div className="absolute top-4 left-4 bg-amber-500 text-white px-3 py-1.5 rounded-full text-[10px] font-semibold uppercase tracking-wider flex items-center gap-1 shadow-sm z-10">
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="bg-surface-1 rounded-2xl p-4 grid grid-cols-2 gap-4 mb-4 border-2 border-border">
          <div className="flex flex-col gap-0.5">
            <span className="text-xs font-bold uppercase tracking-wider text-ink-3">Revenus Générés</span>
        ...
        <div className="flex gap-2 flex-wrap mb-4">
           {(checkExpiry(vehicle.insurance_date) || isExpired(vehicle.insurance_date)) && (
             <span className={cn(
               ...
               isExpired(vehicle.insurance_date)
