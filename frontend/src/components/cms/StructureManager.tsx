...
export default function StructureManager({ form, setForm }: StructureManagerProps) {
  return (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
          ...
          <div className="xl:col-span-8 space-y-8">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-8 rounded-[32px] bg-indigo-50/30 border border-indigo-100/50 group hover:bg-indigo-50 transition-all cursor-pointer">
                ...
                <div className="p-8 rounded-[32px] bg-emerald-50/30 border border-emerald-100/50 group hover:bg-emerald-50 transition-all cursor-pointer">
