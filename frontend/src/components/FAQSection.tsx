      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20 max-w-2xl mx-auto space-y-6">
          ...
          >
            ...
            <span className="text-xs font-bold text-ink-3 uppercase tracking-wider">{content?.badge || "Support Client"}</span>
          </motion.div>
          ...
          >
            {content?.subtitle || t("faq_subtitle")}
          </motion.p>
        </div>
        ...
        >
          <p className="text-sm text-ink-3">{content?.contact_text || "Vous avez encore des questions ?"}</p>
          <Link
            href={content?.contact_link || "/contact"}
          ...
          >
            {content?.contact_button || "Contacter le support"}
