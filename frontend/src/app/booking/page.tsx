...
import { Check, Car, Calendar, User, CreditCard, Loader2, Shield, Navigation, Plane, X, Info, ChevronRight, Lock, FileText, ScanLine, Camera, Rotate3d, Maximize2, PenTool, RotateCcw, Users, Fuel, Settings2 } from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="mb-8 min-h-[400px]">
              ...
              {/* STEP 5: PAYMENT — Real Stripe Checkout */}
              {step === 5 && (
                  ...
                  <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium">Payez uniquement 10% d'acompte pour bloquer le véhicule.</p>
                      </div>
                    </div>
