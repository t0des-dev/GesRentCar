...
export default function BookingPage() {
  ...
  const displayVehicles = useMemo(() => {
    ...
    return vehiclesData.data.map(v => ({
      ...
      type: "Premium",
      img: v.image_url ? `${(process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000/api/v1").replace("/api/v1", "")}${v.image_url}` : "https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&q=80&w=600",
