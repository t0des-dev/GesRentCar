                ...
                {loading ? (
                  ...
                  filteredExpenses.map((exp) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        {exp.receipt_url ? (
                          <a href={`http://localhost:8000${exp.receipt_url}`} target="_blank" rel="noreferrer" className="text-primary hover:text-primary-dark inline-flex items-center gap-1 text-xs font-bold">
