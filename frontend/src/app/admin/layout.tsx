...
import {
  LayoutDashboard, Calendar, Car, Palette, Users, Settings, BarChart3, Sliders, Wallet, ClipboardList, FlaskConical, Ban, FileUp, ScrollText, FileText, MapPin
} from "lucide-react";
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Car, label: t("sidebar_item_fleet_cms") || "Page Fleet", href: "/admin/fleet-cms" },
